...
Исполняемый JAR (Java Archive) файл используется для запуска приложения, написанного на языке программирования Java, в окружении, где установлено выполнение Java (JRE). </p>
