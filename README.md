...
Здесь можно схематично отобразить взаимодействие классов, компонентов и последовательности, позволяющие визуализировать взаимодействие компонентов и последовательность выполнения операций
